                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('converter.store') }}" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="from_currency" aria-describedby="emailHelp" name="from_currency">
                      </div>
                      <div class="mb-3">
                        <label for="from_currency_description" class="form-label">From Currency Description</label>
                        <input type="text" class="form-control" id="from_currency_description" name="from_currency_description">
                      </div>
                      <div class="mb-3">
                        <label for="to_currency" class="form-label">To Currency</label>
                        <input type="text" class="form-control" id="to_currency" aria-describedby="emailHelp" name="to_currency">
                      </div>
                      <div class="mb-3">
                        <label for="to_currency_description" class="form-label">To Currency Description</label>
                        <input type="text" class="form-control" id="to_currency_description" name="to_currency_description">
                      </div>
                      <div class="mb-3">
