    ...
    <div class="col-md-7 col-12 left-section d-flex flex-column align-items-center justify-content-center gap-4">
      <div class="container d-flex flex-column align-items-center justify-content-center gap-4">
        ...
        <div class="amount-wrapper w-100 d-flex flex-column align-items-center justify-content-center">
          ...
          <input type="number" id="amount" name="amount" class="form-control text-center rounded-pill w-75" />
        </div>
        ...
        <div class="buttons w-75">
          <button id="convert" class="btn btn-primary rounded-pill w-100" type="submit">Convert</button>
        </div>
      </div>
    </div>
